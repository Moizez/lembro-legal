...
> [Portuguese version](../termos.html) is the one that prevails.
...
- It depends on an internet connection on both devices and on cloud infrastructure (Google
  Firebase), described in the [Privacy Policy](privacy.html). It only exists with the explicit
